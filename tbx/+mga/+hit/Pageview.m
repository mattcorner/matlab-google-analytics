    ...
    methods
        ...
        function obj = Pageview(varargin)
            ...
            if isempty(p)
                ...
                p.addRequired('Path', @(p) isStringScalar(p) && ...
                    mga.hit.Hit.validateByteLength(p, 2048, 'Path') && ...
                    mga.hit.Pageview.validateFirstChar(p, '/', 'Path'));
                p.addParameter('Title', string.empty, @(a) isStringScalar(a) && ...
